...
def parse_10k_filing(path, section):
...
def get_risk(path):
    return parse_10k_filing(path, 2)

def get_mda(path):
    return parse_10k_filing(path, 3)

text = get_mda('primary-document.html')[0]
print(text)
